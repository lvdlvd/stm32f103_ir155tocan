...
extern char _sidata, _eidata, _sdata, _edata, _sbss, _ebss;  // provided by linker script
...
static int setSysClockTo72MHz(void) {
    ...
    FPEC.ACR |= FPEC_ACR_PRFTBE;

    // Flash 2 wait state
    FPEC.ACR &= ~FPEC_ACR_LATENCY;
    FPEC.ACR |= FPEC_ACR_LATENCY_2;
