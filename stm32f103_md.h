...
/**
 * @brief FLASH Program/Erase Controller Registers
 */
...
#define AFIO_MAPR_TIM1_REMAP_NOREMAP                                                                 \
    ((uint32_t)0x00000000) /*!< No remap (ETR/PA12, CH1/PA8, CH2/PA9, CH3/PA10, CH4/PA11, BKIN/PB12, \
...
#define AFIO_MAPR_TIM1_REMAP_FULLREMAP                                                                 \
    ((uint32_t)0x000000C0) /*!< Full remap (ETR/PE7, CH1/PE9, CH2/PE11, CH3/PE13, CH4/PE14, BKIN/PE15, \
...
/*******************  Bit definition for FPEC_ACR register  ******************/
#define FPEC_ACR_LATENCY ((uint8_t)0x03) /*!< LATENCY[2:0] bits (Latency) */
#define FPEC_ACR_LATENCY_0 ((uint8_t)0x00) /*!< Bit 0 */
#define FPEC_ACR_LATENCY_1 ((uint8_t)0x01) /*!< Bit 0 */
#define FPEC_ACR_LATENCY_2 ((uint8_t)0x02) /*!< Bit 1 */

#define FPEC_ACR_HLFCYA ((uint8_t)0x08) /*!< Flash Half Cycle Access Enable */
#define FPEC_ACR_PRFTBE ((uint8_t)0x10) /*!< Prefetch Buffer Enable */
#define FPEC_ACR_PRFTBS ((uint8_t)0x20) /*!< Prefetch Buffer Status */

/******************  Bit definition for FPEC_KEYR register  ******************/
#define FPEC_KEYR_FKEYR ((uint32_t)0xFFFFFFFF) /*!< FPEC Key */

/*****************  Bit definition for FPEC_OPTKEYR register  ****************/
#define FPEC_OPTKEYR_OPTKEYR ((uint32_t)0xFFFFFFFF) /*!< Option Byte Key */

/******************  Bit definition for FPEC_SR register  *******************/
#define FPEC_SR_BSY ((uint8_t)0x01) /*!< Busy */
#define FPEC_SR_PGERR ((uint8_t)0x04) /*!< Programming Error */
#define FPEC_SR_WRPRTERR ((uint8_t)0x10) /*!< Write Protection Error */
#define FPEC_SR_EOP ((uint8_t)0x20) /*!< End of operation */

/*******************  Bit definition for FPEC_CR register  *******************/
#define FPEC_CR_PG ((uint16_t)0x0001) /*!< Programming */
#define FPEC_CR_PER ((uint16_t)0x0002) /*!< Page Erase */
#define FPEC_CR_MER ((uint16_t)0x0004) /*!< Mass Erase */
#define FPEC_CR_OPTPG ((uint16_t)0x0010) /*!< Option Byte Programming */
#define FPEC_CR_OPTER ((uint16_t)0x0020) /*!< Option Byte Erase */
#define FPEC_CR_STRT ((uint16_t)0x0040) /*!< Start */
#define FPEC_CR_LOCK ((uint16_t)0x0080) /*!< Lock */
#define FPEC_CR_OPTWRE ((uint16_t)0x0200) /*!< Option Bytes Write Enable */
#define FPEC_CR_ERRIE ((uint16_t)0x0400) /*!< Error Interrupt Enable */
#define FPEC_CR_EOPIE ((uint16_t)0x1000) /*!< End of operation interrupt enable */

/*******************  Bit definition for FPEC_AR register  *******************/
#define FPEC_AR_FAR ((uint32_t)0xFFFFFFFF) /*!< Flash Address */

/******************  Bit definition for FPEC_OBR register  *******************/
#define FPEC_OBR_OPTERR ((uint16_t)0x0001) /*!< Option Byte Error */
#define FPEC_OBR_RDPRT ((uint16_t)0x0002) /*!< Read protection */

#define FPEC_OBR_USER ((uint16_t)0x03FC) /*!< User Option Bytes */
#define FPEC_OBR_WDG_SW ((uint16_t)0x0004) /*!< WDG_SW */
#define FPEC_OBR_nRST_STOP ((uint16_t)0x0008) /*!< nRST_STOP */
#define FPEC_OBR_nRST_STDBY ((uint16_t)0x0010) /*!< nRST_STDBY */
#define FPEC_OBR_BFB2 ((uint16_t)0x0020) /*!< BFB2 */

/******************  Bit definition for FPEC_WRPR register  ******************/
#define FPEC_WRPR_WRP ((uint32_t)0xFFFFFFFF) /*!< Write Protect */

/*----------------------------------------------------------------------------*/

/******************  Bit definition for FPEC_RDP register  *******************/
#define FPEC_RDP_RDP ((uint32_t)0x000000FF) /*!< Read protection option byte */
#define FPEC_RDP_nRDP ((uint32_t)0x0000FF00) /*!< Read protection complemented option byte */

/******************  Bit definition for FPEC_USER register  ******************/
#define FPEC_USER_USER ((uint32_t)0x00FF0000) /*!< User option byte */
#define FPEC_USER_nUSER ((uint32_t)0xFF000000) /*!< User complemented option byte */

/******************  Bit definition for FPEC_Data0 register  *****************/
#define FPEC_Data0_Data0 ((uint32_t)0x000000FF) /*!< User data storage option byte */
#define FPEC_Data0_nData0 ((uint32_t)0x0000FF00) /*!< User data storage complemented option byte */

/******************  Bit definition for FPEC_Data1 register  *****************/
#define FPEC_Data1_Data1 ((uint32_t)0x00FF0000) /*!< User data storage option byte */
#define FPEC_Data1_nData1 ((uint32_t)0xFF000000) /*!< User data storage complemented option byte */

/******************  Bit definition for FPEC_WRP0 register  ******************/
#define FPEC_WRP0_WRP0 ((uint32_t)0x000000FF) /*!< Flash memory write protection option bytes */
#define FPEC_WRP0_nWRP0 ((uint32_t)0x0000FF00) /*!< Flash memory write protection complemented option bytes */

/******************  Bit definition for FPEC_WRP1 register  ******************/
#define FPEC_WRP1_WRP1 ((uint32_t)0x00FF0000) /*!< Flash memory write protection option bytes */
#define FPEC_WRP1_nWRP1 ((uint32_t)0xFF000000) /*!< Flash memory write protection complemented option bytes */

/******************  Bit definition for FPEC_WRP2 register  ******************/
#define FPEC_WRP2_WRP2 ((uint32_t)0x000000FF) /*!< Flash memory write protection option bytes */
#define FPEC_WRP2_nWRP2 ((uint32_t)0x0000FF00) /*!< Flash memory write protection complemented option bytes */

/******************  Bit definition for FPEC_WRP3 register  ******************/
#define FPEC_WRP3_WRP3 ((uint32_t)0x00FF0000) /*!< Flash memory write protection option bytes */
#define FPEC_WRP3_nWRP3 ((uint32_t)0xFF000000) /*!< Flash memory write protection complemented option bytes */
